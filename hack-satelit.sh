...
echo  $red    "|                                     |"
echo  $red    "| Author        : Acep X-Code         |"
echo  $red    "| Contact       : 085797616471        |"
echo  $red    "| My Team       : TKJ CREW CYBER TEAM |"
echo  $red    "| Thanks To     : Hoilul Anwar        |"
echo  $blue "<|======================================|>"
sleep 1
echo " "
...
read -p"╰───────root@acepxcode=•>" Gans;
if [ $Gans = 1 ] || [ $Gans = 01 ]
then
echo $blue"╭──[Mau Kearah Mana]>"
read -p"╰───────root@acepxcode=•>" arah;
sleep 1
...
echo  $green "TKJ CREW CYBER TEAM"
exit
fi
